                                ...
                                <div class="l-f-o__pad-box">
                                    ...
                                    <form class="l-f-o__form" method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="u-s-m-b-30">
                                            ...
                                            <input class="input-text input-text--primary-style" type="email" name="email" id="login-email" placeholder="Enter E-mail" required autofocus>
                                        </div>
                                        <div class="u-s-m-b-30">
                                            <label class="gl-label" for="login-password">PASSWORD *</label>
                                            <input class="input-text input-text--primary-style" type="password" name="password" id="login-password" placeholder="Enter Password" required autocomplete="current-password">
                                        </div>
                                        <div class="gl-inline">
                                            <div class="u-s-m-b-30">
