                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="pd-breadcrumb u-s-m-b-30">
                            <ul class="pd-breadcrumb__list">
                                ...
                                <li class="is-marked">
                                    <a href="shop-side-version-2.html" class="quick-look-product-category" style="text-transform: capitalize;">Electronics</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="pd u-s-m-b-30">
                            <div class="pd-wrap">
                                <div id="js-product-detail-modal">
                                    <div class="quick-look-modal-img-thumbnail"><img class="u-img-fluid" src="" alt="product"></div>
                                </div>
                            </div>
                        ...
                        <div class="pd-detail">
                            ...
                            <div class="u-s-m-b-15">
                                <div class="pd-detail__rating gl-rating-style">
                                    <i class="fas fa-star"></i> <small class="quick-view-rating">4.2 rating</small> |
