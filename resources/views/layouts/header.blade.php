        ...
        <div class="container">
            ...
            <div class="primary-nav">
                ...
                <a class="main-logo" href="{{ route('index') }}">
                    ...
                    <img src="{{ asset('images/logo/logo-1.png') }}" alt="logo"></a>
                <!--====== End - Main Logo ======-->


                <!--====== Search Form ======-->
                <form class="main-form" action="{{ route('page.main.search') }}" method="get">

                    <label for="main-search"></label>

                    <input class="input-text input-text--border-radius input-text--style-1" type="text" name="search" id="main-search" placeholder="Search">
                                ...
                                <ul style="width:120px">
                                    ...
                                    <li>
                                        <form action="{{ route('logout') }}" method="POST">
                                            @csrf
                                            <button type="submit" style="cursor: pointer; display: block; padding: 8px 20px; color: #333333; font-size: 12px; font-weight: 600; background: none; border: none;"><i class="fas fa-lock-open u-s-m-r-6"></i>
                                                <span>Signout</span>
                                            </button>
                                        </form>
                                    </li>
        ...
        <div class="container">
            ...
            <div class="secondary-nav">
                ...
                <div class="menu-init" id="navigation3">
                    ...
                    <span class="total-item-round">{{ countCartItems() }}</span>
                        ...
                        <ul class="ah-list ah-list--design1 ah-list--link-color-secondary">
                            ...
                            <li class="has-dropdown">
                                ...
                                <a class="mini-cart-shop-link"><i class="fas fa-shopping-bag"></i>
                                    ...
                                    <span class="total-item-round">{{ countCartItems() }}</span></a>
                                ...
                                <div class="mini-cart">
                                    ...
                                    <div class="mini-product-container gl-scroll u-s-m-b-15">
                                        <div id="cart_items_in_card">
                                            @php $items = cartItems(); @endphp
                                            @foreach($items as $item)
                                                <!--====== Card for mini cart ======-->
                                                <div class="card-mini-product" id="product{{ $item->id }}">
                                                    <div class="mini-product">
                                                        <div class="mini-product__image-wrapper">

                                                            <a class="mini-product__link" href="product-detail.html">

                                                                <img class="u-img-fluid" src="{{ $item->attributes->image }}" alt="product"></a></div>
                                                        <div class="mini-product__info-wrapper">

                                                            <span class="mini-product__category">

                                                                <a href="shop-side-version-2.html" style="text-transform: capitalize">{{ $item->attributes->category }}</a></span>

                                                            <span class="mini-product__name">

                                                                <a href="product-detail.html" style="text-transform: capitalize">{{ $item->name }}</a></span>
                                                    ...
                                                    <a class="mini-product__delete-link far fa-trash-alt remove_hover_cart_item" data-product="{{ $item->id }}"></a>
                                                </div>
                                    ...
                                    <div class="mini-product-stat">
                                        <div class="mini-total">
                                            ...
                                            <span class="subtotal-value">${{ \Cart::getSubTotal() }}</span></div>
