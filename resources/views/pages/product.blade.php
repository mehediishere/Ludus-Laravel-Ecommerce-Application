                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="pd-breadcrumb u-s-m-b-30">
                            <ul class="pd-breadcrumb__list">
                                ...
                                <li class="is-marked">
                                    <a href="shop-side-version-2.html">{{ ucfirst($productSingle->category) }}</a></li>
                            </ul>
                        </div>
                        ...
                        <div class="pd u-s-m-b-30">
                            <div class="slider-fouc pd-wrap">
                                <div id="pd-o-initiate">
                                    @php $images = explode(',', $productSingle->images); @endphp
                                    @foreach($images as $image)
                                        <div class="pd-o-img-wrap" data-src="{{ $image }}">
                                            <img class="u-img-fluid" src="{{ url($image) }}" data-zoom-image="{{ $image }}" alt="">
                                        </div>
                                    @endforeach
                                </div>
                            ...
                            <div class="u-s-m-t-15">
                                <div class="slider-fouc">
                                    <div id="pd-o-thumbnail">
                                        @foreach($images as $image)
                                            <div>
                                                <img class="u-img-fluid" src="{{ url($image) }}" alt="">
                                            </div>
                                        @endforeach
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-7">
                        ...
                        <div class="pd-detail">
                            <div>
                                ...
                                <span class="pd-detail__name">{{ $productSingle->title }}</span></div>
                            <div>
                                <div class="pd-detail__inline">
                                    <span class="pd-detail__price">${{ $discountedPrice }}</span>
                                    @if(!$productSingle->discountPercentage < 1)
                                    <span class="pd-detail__discount">({{ (int)$productSingle->discountPercentage }}% OFF)</span>
                                    <del class="pd-detail__del">${{ $productSingle->price }}</del>
                                    @endif
                                </div>
                            </div>
                            <div class="u-s-m-b-15">
                                <div class="pd-detail__rating gl-rating-style">
                                    {{ ratingCalculate($productSingle->rating) }}

                                    <span class="pd-detail__review u-s-m-l-4">
                                            <a data-click-scroll="#view-review">1 Reviews</a></span></div>
                            </div>
                            <div class="u-s-m-b-15">
                                <div class="pd-detail__inline">

                                    <span class="pd-detail__stock">{{ $productSingle->stock }} in stock</span>
{{--                                    <span class="pd-detail__left">Only 2 left</span></div>--}}
                            </div>
                            <div class="u-s-m-b-15">

                                <span class="pd-detail__preview-desc">{{ $productSingle->description }}</span></div>
                            <div class="u-s-m-b-15">
                                <div class="pd-detail__inline">
                                    ...
                                    <div class="pd-detail-inline-2">
                                        <div class="u-s-m-b-15">
                                            ...
                                            <div class="input-counter">
                                                ...
                                                <input class="input-counter__text input-counter--text-primary-style cart-product-quantity" type="text" value="1" data-min="1" data-max="100">

                                                <span class="input-counter__plus fas fa-plus"></span></div>
                                            <!--====== End - Input Counter ======-->
                                        </div>
                                        <div class="u-s-m-b-15">
                                            <button class="btn btn--e-brand-b-2 add-to-cart-btn" data-product="{{ $productSingle->id }}" type="button">Add to Cart</button></div>
                                    </div>
                                </form>
                            </div>
                            <div class="u-s-m-b-15">
                            ...
                            <div class="u-s-m-b-30">
                                <div class="product-o product-o--hover-on">
                                    <div class="product-o__wrap">
                                        ...
                                        <div class="product-o__action-wrap">
                                            <ul class="product-o__action-list">
                                                <li>
                                                    <a class="quick_look_btn" data-quick_look_product="{{ $product }}" data-modal="modal" data-modal-id="#quick-look" data-tooltip="tooltip" data-placement="top" title="Quick View"><i class="fas fa-search-plus"></i></a></li>
                                                <li>

                                                    <a class="add_cart_btn" data-add_to_cart="{{ $product->id }}" data-modal="modal" data-modal-id="#add-to-cart" data-tooltip="tooltip" data-placement="top" title="Add to Cart"><i class="fas fa-plus-circle"></i></a></li>
                                                <li>
                                    ...
                                    <span class="product-o__name">
                                            ...
                                            <a href="{{ route('page.product.details', ['id'=>$product->id, 'title'=>$product->title]) }}">{{ $product->title }}</a></span>
                                    <div class="product-o__rating gl-rating-style">
                                        {{ ratingCalculate($product->rating) }}
                                        <span class="product-o__review">(20)</span></div>

                                    @if($product->discountPercentage > 0)
                                        @php $priceAfterDiscount = discountCalculate($product->price, $product->discountPercentage); @endphp
                                        <span class="product-o__price">${{ $priceAfterDiscount }}
    ...
    <script>
        $(function (){
            $(document).on('click', '.add-to-cart-btn', function (e){
                ...
                let quantity = $('.cart-product-quantity').val();
                $.ajax({
                    url: "{{ url("/add-to-cart") }}",
                    method: "POST",
                    data: {
