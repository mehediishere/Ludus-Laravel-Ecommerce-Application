                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="slider-content slider-content--animation">
                                    ...
                                    <span class="content-span-2 u-c-secondary">30% Off On Man's Cloth</span>

                                    <span class="content-span-3 u-c-secondary">Find on best prices, Also Discover most selling products of man's cloth</span>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="slider-content slider-content--animation">
                                    ...
                                    <span class="content-span-1 u-c-secondary">Find Fresh</span>

                                    <span class="content-span-2 u-c-secondary">10% Off On Grocery</span>

                                    <span class="content-span-3 u-c-secondary">Find grocery on best prices, Also Discover most selling products of grocery</span>
                        ...
                        <div class="col-lg-5 col-md-5 u-s-m-b-30">
                            ...
                            <a class="collection" href="#">
                                <div class="aspect aspect--bg-grey aspect--square">
                                    ...
                                    <img class="aspect__img collection__img" src="{{ asset('images/collection/black-friday.jpg') }}" alt=""></div>
                            </a></div>
                        ...
                        <div class="col-lg-5 col-md-5 u-s-m-b-30">
                            ...
                            <a class="collection" href="shop-side-version-2.html">
                                <div class="aspect aspect--bg-grey aspect--square">
                                    ...
                                    <img class="aspect__img collection__img" src="{{ asset('images/collection/light-sales.jpg') }}" alt=""></div>
                            </a></div>
                    </div>
                </div>
            </div>
                            ...
                            @foreach($newProducts as $product)
                                <div class="u-s-m-b-30">
                                    <div class="product-o product-o--hover-on">
                                        <div class="product-o__wrap">
                                            <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                                <img class="aspect__img" src="{{ url($product->thumbnail) }}" alt=""></a>
                                            <div class="product-o__action-wrap">
                                                <ul class="product-o__action-list">
                                                    <li>
                                        ...
                                        <span class="product-o__category">
                                            <a href="shop-side-version-2.html">{{ ucfirst($product->category) }}</a></span>
                                        <span class="product-o__name">
                                        ...
                                        <div class="product-o__rating gl-rating-style">
                                            ...
                                            <span class="product-o__review">(1)</span>
                                        </div>
